<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="editroomdetails.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <asp:TextBox ID="txteditroomnumber" runat="server" class="form-control" placeholder="Enter Number"></asp:TextBox>
                          ...
                          <div class="col-md-6">
                           <div class="form-group">
                               <asp:Button ID="btnroomedit" runat="server" style="margin-top:15px" CssClass="btn btn-danger" Text="Edit" />
                      </div>
                              </div>
                      </div>
                          ...
                          <div class="col-md-6">
                           <div class="form-group">
                              <label for="exampleInputConfirmPassword1">Room Image</label><br />
                               <asp:Image ID="imgroom" runat="server" Width="100" Height="100" />
                          </div>
                              </div>
                      </div>
                      <div class="row " >
        ...
        <asp:Button ID="Button1" runat="server" class="btn btn-gradient-primary mr-2" Text="Update" />
